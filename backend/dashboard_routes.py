...
def get_learner_dashboard(learner_id: str, target_role: str = DEFAULT_TARGET_ROLE) -> DashboardOut:
    try:
...
def get_courses(target_role: str | None = DEFAULT_TARGET_ROLE) -> CoursesOut:
